...
author: "<br>Kuan Liu<br> <br> Health Data Working Group - R workshop"
date: "<br>Nov 28, 2022"
start: "0:0:0"
output:
...
-  For this workshop we assume you know R and Rstudio and used and write output using Rmarkdown before.
...
-  no add, no login/password, no cost!
...
-  You can folk or download a template quarto website I made for this tutorial at **https://github.com/Kuan-Liu/Kuan-Liu.github.io**
...
-  An R package for builing website using R Markdown and [Hugo](https://gohugo.io/)
...
- "Permanent link" to the slides at https://ut-xaringan.kuan-liu.com/#1

- Credit: This template and tutorial is created based on [Tom Mock](https://rstudio-conf-2022.github.io/get-started-quarto/) and [Yihui Xie](https://bookdown.org/yihui/blogdown/)'s work.

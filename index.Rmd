...
-  In this tutorial, we will learn how to build a simple personal website using Quarto and hosting the page on [GitHub](https://github.com/)
...
- Credit: This template and tutorial is created based on [Tom Mock](https://rstudio-conf-2022.github.io/get-started-quarto/)
